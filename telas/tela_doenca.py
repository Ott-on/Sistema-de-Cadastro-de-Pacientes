...
class Doenca(tk.Frame):
    def __init__(self, parent, controller):
        ...
        #mostrar paciente
        label_doenca = Label(Label(self, text ='', width=20, height=4, bg='white'))
        ...
        # botão cadastrar:
        button_cadastrar = Button(self, text='CADASTRAR DOENÇA', font=("Arial", 16), activebackground='#02bae8', bg='#02bae8', fg='white',command=lambda: self.cadastrar_doencas(controller), relief='solid', overrelief='solid', width=20, height=2, borderwidth=0, highlightthickness=0)
    ...
    def pesquisar(self,controller):
        ...
        doenca = self.sistema_doencas.consultar(doenca_selecionada=doenca_selecionada)
