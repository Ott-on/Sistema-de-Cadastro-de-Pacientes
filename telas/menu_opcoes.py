...
class MenuOpcoes(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # botão sair
        button_sair = Button(self, text='SAIR', font=("Arial", 16), bg='#02bae8', fg='white', command=lambda: self.deslogar(controller), relief='solid', overrelief='solid', width=10, height=2, borderwidth=0, highlightthickness=0)
