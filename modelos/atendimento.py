class Atendimento:
    def __init__(self, cpf_paciente, data_atendimento, hora_atendimento, peso_paciente, altura_paciente, relato_paciente, anotacoes_medico, exames_passados, diagnostico_medico, codigo_cid, tratamento_ou_medicamentos_prescritos, ):
